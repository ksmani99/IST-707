...
data = read.csv("HREmployeeAttrition.csv") 

head(data)
#Step:2 Cleaning data that has same value - Employee count, Over18, StandardHours,Employee Number
...
1#Correlation between Marital status and Attrition
...
#CONTD.. Step:4 Feature Selection
