library(RWeka)
trainset <- read.csv("C:/Users/Administrator/Documents/MSDatascience/IST707/Week5/titanic-train.csv")
testset <- read.csv("C:/Users/Administrator/Documents/MSDatascience/IST707/Week5/titanic-test.csv")
...
write.csv(newpred, file="C:/Users/Administrator/Documents/MSDatascience/IST707/Week5/titanic-J48-pred-11-06-2019.csv", row.names=FALSE)
...
colnames(newpred)=c("Passengerid", "Survived")
View(newpred)
write.csv(newpred, file="C:/Users/Administrator/Documents/MSDatascience/IST707/Week5/titanic-J48-pred-11-06-2019-fs.csv", row.names=FALSE)
